          ...
          <div className="p-8 flex flex-col flex-grow relative">
            ...
            <div className="mt-auto pt-2 break-inside-avoid">
                    ...
                    <div className="w-1/3 text-center relative">
                         {settings.stampDataUrl && (
                             <img 
                                ...
                                alt="Stamp" 
                                className="absolute bottom-6 left-1/2 -translate-x-1/2 w-24 h-24 object-contain opacity-90 mix-blend-multiply pointer-events-none z-0"
                ...
                <div className="border-t border-gray-200 pt-1 text-center">
                    {/* Removed 'System Generated by SwiftQuote Pro |' */}
